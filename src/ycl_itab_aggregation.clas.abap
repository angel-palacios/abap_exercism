CLASS ycl_itab_aggregation DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ycl_itab_aggregation IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    out->write( perform_aggregation( VALUE #( ( group = 'a' number = 10 ) ( group = 'b' number = 5 ) ( group = 'a' number = 6 )
                                              ( group = 'c' number = 22 ) ( group = 'a' number = 13 ) ( group = 'c' number = 500 ) ) ) ).
  ENDMETHOD.
